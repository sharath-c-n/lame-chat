angular.module("lamechat").controller('Chat', ['$scope','$window', 'SocketService', 'LoginService',
    'SettingsService','$uibModal','ChatService',
    function ($scope, $window, socket, LoginService, SettingsService,$uibModal,ChatService) {
        var regex = /(&zwj;|&nbsp;)/g;
        var dev = true;
        var friendList;
        var usersTyping = [];
